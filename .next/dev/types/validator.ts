...
// Validate ../../../src/app/api/documents/all/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/documents/all">> = Specific
  const handler = {} as typeof import("../../../src/app/api/documents/all/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../../src/app/api/documents/my/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/documents/my">> = Specific
  const handler = {} as typeof import("../../../src/app/api/documents/my/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
